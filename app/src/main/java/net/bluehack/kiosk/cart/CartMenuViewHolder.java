...
public class CartMenuViewHolder extends RecyclerView.ViewHolder {
    ...
    CircleImageView cart_menu_card_iv_img;
    ...
    RecyclerView cart_required_option_rv_list;

    public CartMenuViewHolder(View itemView) {
        super(itemView);

        this.cardView = (CardView) itemView.findViewById(R.id.cart_menu_card_view);
        this.cart_menu_card_iv_img = (CircleImageView) itemView.findViewById(R.id.cart_menu_card_iv_img);
        ...
        this.cart_required_option_rv_list = (RecyclerView) itemView.findViewById(R.id.cart_required_option_rv_list);
    }
}
